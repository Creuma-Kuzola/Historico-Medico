...
import ucan.edu.HistoricoMedico.services.ConsultaService;
 ...
 */
@Service
public class ConsultaServiceImpl extends AbstractService<Consulta, Integer> implements ConsultaService<Consulta, Integer>
{
